...
function SelectedParty() {
  ...
  // Insert GuestList into the real container
...
function render() {
  ...
  // Replace placeholders with your JS-rendered components
  $app.querySelector("#party-list").replaceWith(PartyList());
  $app.querySelector("#new-party-form").replaceWith(NewPartyForm());
  $app.querySelector("#selected-party").replaceWith(SelectedParty());
}
